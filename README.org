...
** Installation
*** on ArchLinux
one can use [[https://github.com/amtoine/pkgbuilds/blob/main/x86_64/amtoine-icons-git/PKGBUILD][my custom PKGBUILD]] as follows:
#+begin_src bash
...
** Usage
The icons are installed by default in ~/usr/share/icons/amtoine-icons-git/~.
